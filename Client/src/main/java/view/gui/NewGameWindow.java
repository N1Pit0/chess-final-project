...
import view.mouseListener.NewCustomMouseListenerImpl;
...
public class NewGameWindow {
    ...
    public NewGameWindow(String blackName, String whiteName, int hh, int mm, int ss) {
...
//                boardView = new BoardStateView(newBoardState);
//                boardView.repaint();
        ...
        boardView.addMouseListener(new BoardMouseListener(new NewCustomMouseListenerImpl(boardView.getBoardState(), boardView, serverConnection)));
